...
from Highcloud_Contrail.Dust_IWP_PC1_constrain_HCF_test.muqy_20230404_util_useful_functions import (
    dcmap as dcmap,
)
...
Dust_AOD = data_merra2.sel(time=slice("2010", "2021"))["DUEXTTAU"]
Dust_mass = data_merra2.sel(time=slice("2010", "2021"))["DUCMASS"]
