...
# Read the HCF data
Cld_match_PC_gap_IWP_AOD_constrain_mean_2020_hcf = read_filtered_data_out(
    file_name="Cld_match_PC_gap_IWP_AOD_constrain_mean_2020_pristine_hcf.nc"
)

Cld_match_PC_gap_IWP_AOD_constrain_mean_2017_2019_hcf = read_filtered_data_out(
    file_name="Cld_match_PC_gap_IWP_AOD_constrain_mean_2017_2019_pristine_hcf.nc"
)

# Read the IER data
Cld_match_PC_gap_IWP_AOD_constrain_mean_2020 = read_filtered_data_out(
    file_name="Cld_match_PC_gap_IWP_AOD_constrain_mean_2020_pristine_icerad.nc"
)

Cld_match_PC_gap_IWP_AOD_constrain_mean_2017_2019 = read_filtered_data_out(
    file_name="Cld_match_PC_gap_IWP_AOD_constrain_mean_2017_2019_pristine_icerad.nc"
)
