...
(
    ...
    PC_path="/RAID01/data/PC_data/2010_2020_4_parameters_300hPa_PC1_Troppause_temperature.nc",
...
# reshape PC to each year and year-month
PC_all_troppause_temperature = PC_all_troppause_temperature.reshape(
    11, 336, 180, 360
)
...
(
    Corr_PC1_HCF_troppause_temperature,
    _,
) = calc_correlation_pvalue_PC1_Cld(
    Cld_all.reshape(11 * 336, 180, 360),
    PC_all_troppause_temperature.reshape(11 * 336, 180, 360),
)

Corr_PC1_HCF_global_grid, _ = calc_correlation_pvalue_PC1_Cld(
    Cld_all.reshape(11 * 336, 180, 360),
    PC_all_global_grid.reshape(11 * 336, 180, 360),
)
...
plot_corr_full_hemisphere_self_cmap(
    ...
    1,
    "Corr",
    "PC1-HCF Troppause Temperature",
    0,
)

plot_corr_full_hemisphere_self_cmap(
    Corr_PC1_HCF_global_grid, -1, 1, "Corr", "PC1-HCF global", 0
)

# plot the corr difference between PC1 and Cld each grid point
# vs global grid
plot_corr_full_hemisphere_self_cmap(
    Corr_PC1_HCF_troppause_temperature - Corr_PC1_HCF_global_grid,
    -0.24,
    0.24,
    "Corr difference",
    "PC1-HCF",
