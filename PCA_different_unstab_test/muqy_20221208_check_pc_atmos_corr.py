...
(
    ...
    PC_path="/RAID01/data/PC_data/2010_2020_4_parameters_300hPa_PC1_each_grid_point.nc",
...
PC_all_each_grid_point = PC_all_each_grid_point.reshape(
    11, 336, 180, 360
)
...
Corr_PC1_HCF_each_grid_point, _ = calc_correlation_pvalue_PC1_Cld(
    Cld_all.reshape(11 * 336, 180, 360),
    PC_all_each_grid_point.reshape(11 * 336, 180, 360),
)
...
# vs global grid
plot_corr_full_hemisphere_self_cmap(
    Corr_PC1_HCF_each_grid_point - Corr_PC1_HCF_global_grid,
    -0.24,
    0.24,
    "Corr difference",
    "PC1-HCF",
