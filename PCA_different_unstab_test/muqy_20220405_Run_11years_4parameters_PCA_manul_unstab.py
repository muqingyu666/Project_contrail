...
class ERA5_parameters_preproccess_PCA(object):
    ...
    def unstability_calculator(
        ...
        Tl300 = (
            1 / (1 / (T300_1 - 55) - (np.log(RH300_1 / 100)) / 2840)
        ) + 55
        Tl250 = (
            1 / (1 / (T250_1 - 55) - (np.log(RH250_1 / 100)) / 2840)
        ) + 55
        e300 = np.array(
...
def save_PCA_data_as_netcdf(PC_all):
    ...
    ds.to_netcdf(
        "/RAID01/data/PC_data/2010_2020_4_parameters_300hPa_PC1_mannual_stab.nc"
    )
