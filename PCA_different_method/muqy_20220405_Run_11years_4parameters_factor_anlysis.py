...
class ERA5_parameters_preproccess_PCA(object):
    ...
    def Principle_Component_Analysis(
        ...
        # transform the data to float32
        # aim to reduce the memory usage
        ...
        # pca.fit(PC_all)
        PC1 = transformer.fit_transform(PC_all)
...
def save_PCA_data_as_netcdf(PC_all):
    ...
    ds.to_netcdf(
        "/RAID01/data/PC_data/2010_2020_4_parameters_300hPa_PC1_factor_analysis.nc"
    )
