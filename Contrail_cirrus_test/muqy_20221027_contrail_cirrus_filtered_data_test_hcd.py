...
plot_Cld_no_mean_simple_full_hemisphere_self_cmap(
    Cld_match_PC_gap=Cld_all[0, 10, 0, :, :],
    # p_value,
    cld_min=0,
    cld_max=65,
...
PC_all_4_para = PC_all_4_para.reshape(11, 12, 28, 180, 360)
plot_Cld_no_mean_simple_full_hemisphere_self_cmap(
    Cld_match_PC_gap=PC_all_4_para[0, 10, 0, :, :],
    # p_value,
    cld_min=-2,
    cld_max=4,
    cld_name="Cloud fraction",
...
(
    ...
    PC_data=PC_all_4_para.reshape(-1, 180, 360),
)
# endregion
