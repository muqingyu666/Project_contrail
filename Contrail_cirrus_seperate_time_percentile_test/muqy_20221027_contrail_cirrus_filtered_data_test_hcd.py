...
(
    ...
    PC_para_num=0, CERES_Cld_dataset_num=0
)


def extract_PC1_CERES_each_year(PC_years, Cld_years):
...
# 1-2 month
for i in range(0, 3):
    # Calculate mean for each month range separately
    mean_2010_2019 = np.nanmean(
        Cld_2010_2019_match_PC_gap_filtered_1_2_month_mean[
            int(gap_num_min[i]) : int(gap_num_max[i]), 110:140, :
        ],
        axis=(0, 1),
    )
    mean_2020 = np.nanmean(
        Cld_2020_match_PC_gap_filtered_1_2_month_mean[
            int(gap_num_min[i]) : int(gap_num_max[i]), 110:140, :
        ],
        axis=(0, 1),
    ...
    Cld_delta_2020_match_PC_gap_filtered_1_2_month_mean[i] = (
        (mean_2020 - mean_2010_2019) / mean_2010_2019
    ) * 100
    ...
    Cld_delta_2020_match_PC_gap_filtered_3_4_month_mean[i] = (
        (mean_2020 - mean_2010_2019) / mean_2010_2019
    ) * 100
    ...
    Cld_delta_2020_match_PC_gap_filtered_5_6_month_mean[i] = (
        (mean_2020 - mean_2010_2019) / mean_2010_2019
    ) * 100
    ...
    Cld_delta_2020_match_PC_gap_filtered_7_8_month_mean[i] = (
        (mean_2020 - mean_2010_2019) / mean_2010_2019
    ) * 100
...
for i, atm in enumerate(atm_conditions):
    for calc_type in calc_types:
        ...
        # call the compare_cld_between_2020_others_percentile function
        results = compare_cld_between_2020_others_percentile(
...
# --------------------------------------------
# set universal boundaries for each time period
# y lim are set for each atmospheric condition (bad, moderate, good)

y_lim_lst = [[-80, 115], [-60, 170], [-50, 140]]
...
compare_cld_between_PC_condition_by_each_Lat_smoothed_aviation_fill_median_mean_with_actual_aviation_improve(
    ...
    Cld_data_PC_condition_1_median=Cld_all_match_PC_gap_sub_2020_3_4_month_moderate_filtered_median,
    Cld_data_PC_condition_2_median=Cld_all_match_PC_gap_sub_2020_3_4_month_good_filtered_median,
    Cld_data_aux_proses=Cld_delta_2020_match_PC_gap_filtered_3_4_month_mean,
    Cld_data_name=r"$\Delta$" + "HCF(%)",
    y_lim_lst=y_lim_lst,
    title="March-April",
    step=5,
...
compare_cld_between_PC_condition_by_each_Lat_smoothed_aviation_fill_median_mean_with_actual_aviation_improve(
    ...
    Cld_data_PC_condition_1_median=Cld_all_match_PC_gap_sub_2020_5_6_month_moderate_filtered_median,
    Cld_data_PC_condition_2_median=Cld_all_match_PC_gap_sub_2020_5_6_month_good_filtered_median,
    Cld_data_aux_proses=Cld_delta_2020_match_PC_gap_filtered_5_6_month_mean,
    Cld_data_name=r"$\Delta$" + "HCF(%)",
    y_lim_lst=y_lim_lst,
    title="May-June",
    step=5,
...
compare_cld_between_PC_condition_by_each_Lat_smoothed_aviation_fill_median_mean_with_actual_aviation_improve(
    ...
    Cld_data_PC_condition_1_median=Cld_all_match_PC_gap_sub_2020_7_8_month_moderate_filtered_median,
    Cld_data_PC_condition_2_median=Cld_all_match_PC_gap_sub_2020_7_8_month_good_filtered_median,
    Cld_data_aux_proses=Cld_delta_2020_match_PC_gap_filtered_7_8_month_mean,
    Cld_data_name=r"$\Delta$" + "HCF(%)",
    y_lim_lst=y_lim_lst,
    title="July-August",
    step=5,
