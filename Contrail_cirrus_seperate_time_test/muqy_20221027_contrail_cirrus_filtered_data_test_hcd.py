...
dividePC = DividePCByDataVolume(
    dataarray_main=PC_2020_1_2_month[:, 110:140, :],
    n=5,
    start=-2.5,
    end=5.5,
    gap=0.05,
...
# 3 - 4 month
dividePC = DividePCByDataVolume(
    dataarray_main=PC_2020_3_4_month[:, 110:140, :],
    n=5,
    start=-2.5,
    end=5.5,
    gap=0.05,
...
# 5 - 6 month
dividePC = DividePCByDataVolume(
    dataarray_main=PC_2020_5_6_month[:, 110:140, :],
    n=5,
    start=-2.5,
    end=5.5,
    gap=0.05,
...
# 7 - 8 month
dividePC = DividePCByDataVolume(
    dataarray_main=PC_2020_7_8_month[:, 110:140, :],
    n=5,
    start=-2.5,
    end=5.5,
    gap=0.05,
