...
def read_PC1_CERES_from_netcdf_except_2010(PC_path, CERES_Cld_dataset_num):
    """
    Read the PC1 and CERES data from the netcdf file
    you can choose the PC1 and CERES data you want to read
    PC1 data :
    ...
    # Arrange data from all years
    PC_all = PC_all.reshape(217728000)
    PC_all = PC_all.reshape(120, 28, 180, 360)

    # region
    PC_all = PC_all.reshape(3360, 180, 360)
    # endregion
