# -*- coding: utf-8 -*-
"""
Created on Mon Jul  5 18:33:08 2021
...
data0 = xr.open_dataset(
    "/RAID01/data/muqy/PYTHONDATA/2010_2020EOF_Cld.nc"
)
...
Box = np.zeros((119750400, 16))
Box_1 = np.zeros((119750400, 16))
for i in range(0, 16):
    Box[:, i] = A_Z[:, :, i, :, :].reshape(119750400)
    Box_1[:, i] = A_TEMP[:, :, i, :, :].reshape(119750400)

Box_P = pd.DataFrame(Box)
Box_P1 = pd.DataFrame(Box_1)
Box_P.columns = [np.arange(-2, 5.6, 0.5)]
Box_P1.columns = [np.arange(-2, 5.6, 0.5)]
...
plt.ylim(0, 100)
# plt.savefig('/RAID01/data/boxplot'+'0.png',dpi=300,bbox_inches='tight')
plt.show()
...
plt.savefig(
    "/RAID01/data/boxplot" + "1.png", dpi=300, bbox_inches="tight"
)
...
for num1, num2, num3, num4 in product(
    ...
    Cld_anormally_2020[num1, num2, num3, num4] = (
        (
            np.nansum(Cld_2020[num1, :, num2, num3, num4], axis=0)
            - (
                np.array(
                    Cld_2020[num1, :, num2, num3, num4][
                        ~np.isnan(
                            Cld_2020[num1, :, num2, num3, num4]
                        )
                    ].shape
            ...
            * Cld_mean_filtered[num1, num2, num3, num4]
        )
    ) / (
        (
            np.array(
                Cld_2020[num1, :, num2, num3, num4][
                    ~np.isnan(Cld_2020[num1, :, num2, num3, num4])
                ].shape
            )
        )
        * Cld_mean_filtered[num1, num2, num3, num4]
    )
    Cld_anormally_2019[num1, num2, num3, num4] = (
        (
            np.nansum(Cld_2019[num1, :, num2, num3, num4], axis=0)
            - (
                np.array(
                    Cld_2019[num1, :, num2, num3, num4][
                        ~np.isnan(
                            Cld_2019[num1, :, num2, num3, num4]
                        )
                    ].shape
        ...
        (
            np.array(
                Cld_2019[num1, :, num2, num3, num4][
                    ~np.isnan(Cld_2019[num1, :, num2, num3, num4])
                ].shape
            )
        )
        * Cld_mean_filtered[num1, num2, num3, num4]
    )
    Cld_anormally_2018[num1, num2, num3, num4] = (
        (
            np.nansum(Cld_2018[num1, :, num2, num3, num4], axis=0)
            - (
                np.array(
                    Cld_2018[num1, :, num2, num3, num4][
                        ~np.isnan(
                            Cld_2018[num1, :, num2, num3, num4]
                        )
                    ].shape
        ...
        (
            np.array(
                Cld_2018[num1, :, num2, num3, num4][
                    ~np.isnan(Cld_2018[num1, :, num2, num3, num4])
                ].shape
            )
        )
        * Cld_mean_filtered[num1, num2, num3, num4]
    )
    Cld_anormally_2017[num1, num2, num3, num4] = (
        (
            np.nansum(Cld_2017[num1, :, num2, num3, num4], axis=0)
            - (
                np.array(
                    Cld_2017[num1, :, num2, num3, num4][
                        ~np.isnan(
                            Cld_2017[num1, :, num2, num3, num4]
                        )
                    ].shape
        ...
        (
            np.array(
                Cld_2017[num1, :, num2, num3, num4][
                    ~np.isnan(Cld_2017[num1, :, num2, num3, num4])
                ].shape
            )
        )
        * Cld_mean_filtered[num1, num2, num3, num4]
    )
    Cld_anormally_2016[num1, num2, num3, num4] = (
        (
            np.nansum(Cld_2016[num1, :, num2, num3, num4], axis=0)
            - (
                np.array(
                    Cld_2016[num1, :, num2, num3, num4][
                        ~np.isnan(
                            Cld_2016[num1, :, num2, num3, num4]
                        )
                    ].shape
        ...
        (
            np.array(
                Cld_2016[num1, :, num2, num3, num4][
                    ~np.isnan(Cld_2016[num1, :, num2, num3, num4])
                ].shape
            )
        )
        * Cld_mean_filtered[num1, num2, num3, num4]
    )
    Cld_anormally_2015[num1, num2, num3, num4] = (
        (
            np.nansum(Cld_2015[num1, :, num2, num3, num4], axis=0)
            - (
                np.array(
                    Cld_2015[num1, :, num2, num3, num4][
                        ~np.isnan(
                            Cld_2015[num1, :, num2, num3, num4]
                        )
                    ].shape
        ...
        (
            np.array(
                Cld_2015[num1, :, num2, num3, num4][
                    ~np.isnan(Cld_2015[num1, :, num2, num3, num4])
                ].shape
            )
        )
        * Cld_mean_filtered[num1, num2, num3, num4]
    )
    Cld_anormally_2014[num1, num2, num3, num4] = (
        (
            np.nansum(Cld_2014[num1, :, num2, num3, num4], axis=0)
            - (
                np.array(
                    Cld_2014[num1, :, num2, num3, num4][
                        ~np.isnan(
                            Cld_2014[num1, :, num2, num3, num4]
                        )
                    ].shape
        ...
        (
            np.array(
                Cld_2014[num1, :, num2, num3, num4][
                    ~np.isnan(Cld_2014[num1, :, num2, num3, num4])
                ].shape
            )
        )
        * Cld_mean_filtered[num1, num2, num3, num4]
    )
    Cld_anormally_2013[num1, num2, num3, num4] = (
        (
            np.nansum(Cld_2013[num1, :, num2, num3, num4], axis=0)
            - (
                np.array(
                    Cld_2013[num1, :, num2, num3, num4][
                        ~np.isnan(
                            Cld_2013[num1, :, num2, num3, num4]
                        )
                    ].shape
        ...
        (
            np.array(
                Cld_2013[num1, :, num2, num3, num4][
                    ~np.isnan(Cld_2013[num1, :, num2, num3, num4])
                ].shape
            )
        )
        * Cld_mean_filtered[num1, num2, num3, num4]
    )
    Cld_anormally_2012[num1, num2, num3, num4] = (
        (
            np.nansum(Cld_2012[num1, :, num2, num3, num4], axis=0)
            - (
                np.array(
                    Cld_2012[num1, :, num2, num3, num4][
                        ~np.isnan(
                            Cld_2012[num1, :, num2, num3, num4]
                        )
                    ].shape
        ...
        (
            np.array(
                Cld_2012[num1, :, num2, num3, num4][
                    ~np.isnan(Cld_2012[num1, :, num2, num3, num4])
                ].shape
            )
        )
        * Cld_mean_filtered[num1, num2, num3, num4]
    )
    Cld_anormally_2011[num1, num2, num3, num4] = (
        (
            np.nansum(Cld_2011[num1, :, num2, num3, num4], axis=0)
            - (
                np.array(
                    Cld_2011[num1, :, num2, num3, num4][
                        ~np.isnan(
                            Cld_2011[num1, :, num2, num3, num4]
                        )
                    ].shape
        ...
        (
            np.array(
                Cld_2011[num1, :, num2, num3, num4][
                    ~np.isnan(Cld_2011[num1, :, num2, num3, num4])
                ].shape
            )
        )
        * Cld_mean_filtered[num1, num2, num3, num4]
    )
    Cld_anormally_2010[num1, num2, num3, num4] = (
        (
            np.nansum(Cld_2010[num1, :, num2, num3, num4], axis=0)
            - (
                np.array(
                    Cld_2010[num1, :, num2, num3, num4][
                        ~np.isnan(
                            Cld_2010[num1, :, num2, num3, num4]
                        )
                    ].shape
        ...
        (
            np.array(
                Cld_2010[num1, :, num2, num3, num4][
                    ~np.isnan(Cld_2010[num1, :, num2, num3, num4])
                ].shape
            )
        )
        * Cld_mean_filtered[num1, num2, num3, num4]
...
for num1, num2 in product(numlist1, numlist2):
    Cld_anormally_2020[num1, num2, :, :] = (
        (
            np.nansum(Cld_2020[num1, :, num2, :, :], axis=0)
            - (
                np.array(
                    Cld_2020[num1, :, num2, :, :][
                        ~np.isnan(Cld_2020[num1, :, num2, :, :])
                    ].shape
                )
            )
            * Cld_mean_filtered[num1, num2, :, :]
        )
    ) / (
        (
            np.array(
    ...
    Cld_anormally_2019[num1, num2, :, :] = (
        (
            np.nansum(Cld_2019[num1, :, num2, :, :], axis=0)
            - (
                np.array(
                    Cld_2019[num1, :, num2, :, :][
                        ~np.isnan(Cld_2019[num1, :, num2, :, :])
                    ].shape
                )
            )
            * Cld_mean_filtered[num1, num2, :, :]
    ...
    Cld_anormally_2018[num1, num2, :, :] = (
        (
            np.nansum(Cld_2018[num1, :, num2, :, :], axis=0)
            - (
                np.array(
                    Cld_2018[num1, :, num2, :, :][
                        ~np.isnan(Cld_2018[num1, :, num2, :, :])
                    ].shape
                )
            )
            * Cld_mean_filtered[num1, num2, :, :]
    ...
    Cld_anormally_2017[num1, num2, :, :] = (
        (
            np.nansum(Cld_2017[num1, :, num2, :, :], axis=0)
            - (
                np.array(
                    Cld_2017[num1, :, num2, :, :][
                        ~np.isnan(Cld_2017[num1, :, num2, :, :])
                    ].shape
                )
            )
            * Cld_mean_filtered[num1, num2, :, :]
    ...
    Cld_anormally_2016[num1, num2, :, :] = (
        (
            np.nansum(Cld_2016[num1, :, num2, :, :], axis=0)
            - (
                np.array(
                    Cld_2016[num1, :, num2, :, :][
                        ~np.isnan(Cld_2016[num1, :, num2, :, :])
                    ].shape
                )
            )
            * Cld_mean_filtered[num1, num2, :, :]
    ...
    Cld_anormally_2015[num1, num2, :, :] = (
        (
            np.nansum(Cld_2015[num1, :, num2, :, :], axis=0)
            - (
                np.array(
                    Cld_2015[num1, :, num2, :, :][
                        ~np.isnan(Cld_2015[num1, :, num2, :, :])
                    ].shape
                )
            )
            * Cld_mean_filtered[num1, num2, :, :]
    ...
    Cld_anormally_2014[num1, num2, :, :] = (
        (
            np.nansum(Cld_2014[num1, :, num2, :, :], axis=0)
            - (
                np.array(
                    Cld_2014[num1, :, num2, :, :][
                        ~np.isnan(Cld_2014[num1, :, num2, :, :])
                    ].shape
                )
            )
            * Cld_mean_filtered[num1, num2, :, :]
    ...
    Cld_anormally_2013[num1, num2, :, :] = (
        (
            np.nansum(Cld_2013[num1, :, num2, :, :], axis=0)
            - (
                np.array(
                    Cld_2013[num1, :, num2, :, :][
                        ~np.isnan(Cld_2013[num1, :, num2, :, :])
                    ].shape
                )
            )
            * Cld_mean_filtered[num1, num2, :, :]
    ...
    Cld_anormally_2012[num1, num2, :, :] = (
        (
            np.nansum(Cld_2012[num1, :, num2, :, :], axis=0)
            - (
                np.array(
                    Cld_2012[num1, :, num2, :, :][
                        ~np.isnan(Cld_2012[num1, :, num2, :, :])
                    ].shape
                )
            )
            * Cld_mean_filtered[num1, num2, :, :]
    ...
    Cld_anormally_2011[num1, num2, :, :] = (
        (
            np.nansum(Cld_2011[num1, :, num2, :, :], axis=0)
            - (
                np.array(
                    Cld_2011[num1, :, num2, :, :][
                        ~np.isnan(Cld_2011[num1, :, num2, :, :])
                    ].shape
                )
            )
            * Cld_mean_filtered[num1, num2, :, :]
    ...
    Cld_anormally_2010[num1, num2, :, :] = (
        (
            np.nansum(Cld_2010[num1, :, num2, :, :], axis=0)
            - (
                np.array(
                    Cld_2010[num1, :, num2, :, :][
                        ~np.isnan(Cld_2010[num1, :, num2, :, :])
                    ].shape
                )
            )
            * Cld_mean_filtered[num1, num2, :, :]
...
ds = xr.Dataset(
    {
        "Cld_anormally_2020": (
            ("Month", "EOFGAP", "Latitude", "Longitude"),
            Cld_anormally_2020[:, :, :, :],
        ),
        "Cld_anormally_2019": (
            ("Month", "EOFGAP", "Latitude", "Longitude"),
    ...
    coords={
        ...
        "LON": ("Longitude", np.linspace(0, 359, 360)),
        "EOFGAP": ("EOFGAP", np.linspace(0, 15, 16)),
        "MONTH": ("Month", np.linspace(0, 5, 6)),
    },
)

# os.makedirs('F:\\PYTHONDATA\\',exist_ok=True)
ds.to_netcdf(
    "/RAID01/data/muqy/PYTHONDATA/Cld_anormally_data" + ".nc"
)

###################################### Complex plot ###############################################################

### using cld_anormallly data ###
...
def Alphaplot(j, i):
    ...
    lat = np.linspace(-90, 89, 180)
    fig = plt.figure(figsize=(10, 12))
    cmap = dcmap("/RAID01/data/muqy/color/blue_w_red.txt")
    cmap.set_bad("gray")
    cmap.set_over("#800000")
    cmap.set_under("#191970")
    ax1 = plt.subplot(
