...
for i in range(0, 33):
    ...
    for i in range(0, 28):
        ...
        T250[i, :, :] = np.flipud(T250[i, :, :])
        T300[i, :, :] = np.flipud(T300[i, :, :])
        RH[i, :, :] = np.flipud(RH[i, :, :])
        W[i, :, :] = np.flipud(W[i, :, :])
        Z[i, :, :] = np.flipud(Z[i, :, :])
        Z1[i, :, :] = np.flipud(Z1[i, :, :])
        ...
        T250_1 = np.array(T250[i, :, :]).reshape(64800)
        T300_1 = np.array(T300[i, :, :]).reshape(64800)
        W_1 = np.array(W[i, :, :]).reshape(64800)
        Z_1 = np.array(Z[i, :, :]).reshape(64800)
        Z1_1 = np.array(Z1[i, :, :]).reshape(64800)

        sita300 = np.array(
            mpcalc.potential_temperature(
                300.0 * units.mbar, T300_1 * units.kelvin
            )
        )
        sita250 = np.array(
            mpcalc.potential_temperature(
                250.0 * units.mbar, T250_1 * units.kelvin
            )
        )
...
A_NM = A_N20
A_N30 = A_N20[0:3, :, :, :]  # 2010
A_N40 = A_N20[3:6, :, :, :]  # 2011
A_N50 = A_N20[6:9, :, :, :]  # 2012
A_N60 = A_N20[9:12, :, :, :]  # 2013
A_N70 = A_N20[12:15, :, :, :]  # 2014
A_N80 = A_N20[15:18, :, :, :]  # 2015
A_N90 = A_N20[18:21, :, :, :]  # 2016
A_N100 = A_N20[21:24, :, :, :]  # 2017
A_N101 = A_N20[24:27, :, :, :]  # 2018
A_N102 = A_N20[27:30, :, :, :]  # 2019
A_N103 = A_N20[30:33, :, :, :]  # 2020

A_N20 = A_N20.reshape(59875200)
A_NM = A_NM.reshape(59875200)
...
B_N0[0] = np.nanmean(
    A_NM[np.where((A_N1 > -4) & (A_N1 <= -3.75))]
)
B_N0[1] = np.nanmean(
    A_NM[np.where((A_N1 > -3.75) & (A_N1 <= -3.5))]
)
B_N0[2] = np.nanmean(
    A_NM[np.where((A_N1 > -3.5) & (A_N1 <= -3.25))]
)
B_N0[3] = np.nanmean(
    A_NM[np.where((A_N1 > -3.25) & (A_N1 <= -3))]
)
B_N0[4] = np.nanmean(
    A_NM[np.where((A_N1 > -3) & (A_N1 <= -2.75))]
)
B_N0[5] = np.nanmean(
    A_NM[np.where((A_N1 > -2.75) & (A_N1 <= -2.5))]
)
B_N0[6] = np.nanmean(
    A_NM[np.where((A_N1 > -2.5) & (A_N1 <= -2.25))]
)
B_N0[7] = np.nanmean(
    A_NM[np.where((A_N1 > -2.25) & (A_N1 <= -2))]
)
B_N0[8] = np.nanmean(
    A_NM[np.where((A_N1 > -2) & (A_N1 <= -1.75))]
)
B_N0[9] = np.nanmean(
    A_NM[np.where((A_N1 > -1.75) & (A_N1 <= -1.5))]
)
B_N0[10] = np.nanmean(
    A_NM[np.where((A_N1 > -1.5) & (A_N1 <= -1.25))]
)
B_N0[11] = np.nanmean(
    A_NM[np.where((A_N1 > -1.25) & (A_N1 <= -1))]
)
B_N0[12] = np.nanmean(
    A_NM[np.where((A_N1 > -1) & (A_N1 <= -0.75))]
)
B_N0[13] = np.nanmean(
    A_NM[np.where((A_N1 > -0.75) & (A_N1 <= -0.5))]
)
B_N0[14] = np.nanmean(
    A_NM[np.where((A_N1 > -0.5) & (A_N1 <= -0.25))]
)
B_N0[15] = np.nanmean(
    A_NM[np.where((A_N1 > -0.25) & (A_N1 <= 0))]
)
B_N0[16] = np.nanmean(A_NM[np.where((A_N1 > 0) & (A_N1 <= 0.25))])
B_N0[17] = np.nanmean(
    A_NM[np.where((A_N1 > 0.25) & (A_N1 <= 0.5))]
)
B_N0[18] = np.nanmean(
    A_NM[np.where((A_N1 > 0.5) & (A_N1 <= 0.75))]
)
B_N0[19] = np.nanmean(A_NM[np.where((A_N1 > 0.75) & (A_N1 <= 1))])
B_N0[20] = np.nanmean(A_NM[np.where((A_N1 > 1) & (A_N1 <= 1.25))])
B_N0[21] = np.nanmean(
    A_NM[np.where((A_N1 > 1.25) & (A_N1 <= 1.5))]
)
B_N0[22] = np.nanmean(
    A_NM[np.where((A_N1 > 1.5) & (A_N1 <= 1.75))]
)
B_N0[23] = np.nanmean(A_NM[np.where((A_N1 > 1.75) & (A_N1 <= 2))])
B_N0[24] = np.nanmean(A_NM[np.where((A_N1 > 2) & (A_N1 <= 2.25))])
B_N0[25] = np.nanmean(
    A_NM[np.where((A_N1 > 2.25) & (A_N1 <= 2.5))]
)
B_N0[26] = np.nanmean(
    A_NM[np.where((A_N1 > 2.5) & (A_N1 <= 2.75))]
)
B_N0[27] = np.nanmean(A_NM[np.where((A_N1 > 2.75) & (A_N1 <= 3))])
B_N0[28] = np.nanmean(A_NM[np.where((A_N1 > 3) & (A_N1 <= 3.25))])
B_N0[29] = np.nanmean(
    A_NM[np.where((A_N1 > 3.25) & (A_N1 <= 3.5))]
)
B_N0[30] = np.nanmean(
    A_NM[np.where((A_N1 > 3.5) & (A_N1 <= 3.75))]
)
B_N0[31] = np.nanmean(A_NM[np.where((A_N1 > 3.75) & (A_N1 <= 4))])
...
B_N8[0] = np.nanmean(
    A_N101[np.where((A_N111 > -4) & (A_N111 <= -3.75))]
)
B_N8[1] = np.nanmean(
    A_N101[np.where((A_N111 > -3.75) & (A_N111 <= -3.5))]
)
B_N8[2] = np.nanmean(
    A_N101[np.where((A_N111 > -3.5) & (A_N111 <= -3.25))]
)
B_N8[3] = np.nanmean(
    A_N101[np.where((A_N111 > -3.25) & (A_N111 <= -3))]
)
B_N8[4] = np.nanmean(
    A_N101[np.where((A_N111 > -3) & (A_N111 <= -2.75))]
)
B_N8[5] = np.nanmean(
    A_N101[np.where((A_N111 > -2.75) & (A_N111 <= -2.5))]
)
B_N8[6] = np.nanmean(
    A_N101[np.where((A_N111 > -2.5) & (A_N111 <= -2.25))]
)
B_N8[7] = np.nanmean(
    A_N101[np.where((A_N111 > -2.25) & (A_N111 <= -2))]
)
B_N8[8] = np.nanmean(
    A_N101[np.where((A_N111 > -2) & (A_N111 <= -1.75))]
)
B_N8[9] = np.nanmean(
    A_N101[np.where((A_N111 > -1.75) & (A_N111 <= -1.5))]
)
B_N8[10] = np.nanmean(
    A_N101[np.where((A_N111 > -1.5) & (A_N111 <= -1.25))]
)
B_N8[11] = np.nanmean(
    A_N101[np.where((A_N111 > -1.25) & (A_N111 <= -1))]
)
B_N8[12] = np.nanmean(
    A_N101[np.where((A_N111 > -1) & (A_N111 <= -0.75))]
)
B_N8[13] = np.nanmean(
    A_N101[np.where((A_N111 > -0.75) & (A_N111 <= -0.5))]
)
B_N8[14] = np.nanmean(
    A_N101[np.where((A_N111 > -0.5) & (A_N111 <= -0.25))]
)
B_N8[15] = np.nanmean(
    A_N101[np.where((A_N111 > -0.25) & (A_N111 <= 0))]
)
B_N8[16] = np.nanmean(
    A_N101[np.where((A_N111 > 0) & (A_N111 <= 0.25))]
)
B_N8[17] = np.nanmean(
    A_N101[np.where((A_N111 > 0.25) & (A_N111 <= 0.5))]
)
B_N8[18] = np.nanmean(
    A_N101[np.where((A_N111 > 0.5) & (A_N111 <= 0.75))]
)
B_N8[19] = np.nanmean(
    A_N101[np.where((A_N111 > 0.75) & (A_N111 <= 1))]
)
B_N8[20] = np.nanmean(
    A_N101[np.where((A_N111 > 1) & (A_N111 <= 1.25))]
)
B_N8[21] = np.nanmean(
    A_N101[np.where((A_N111 > 1.25) & (A_N111 <= 1.5))]
)
B_N8[22] = np.nanmean(
    A_N101[np.where((A_N111 > 1.5) & (A_N111 <= 1.75))]
)
B_N8[23] = np.nanmean(
    A_N101[np.where((A_N111 > 1.75) & (A_N111 <= 2))]
)
B_N8[24] = np.nanmean(
    A_N101[np.where((A_N111 > 2) & (A_N111 <= 2.25))]
)
B_N8[25] = np.nanmean(
    A_N101[np.where((A_N111 > 2.25) & (A_N111 <= 2.5))]
)
B_N8[26] = np.nanmean(
    A_N101[np.where((A_N111 > 2.5) & (A_N111 <= 2.75))]
)
B_N8[27] = np.nanmean(
    A_N101[np.where((A_N111 > 2.75) & (A_N111 <= 3))]
)
B_N8[28] = np.nanmean(
    A_N101[np.where((A_N111 > 3) & (A_N111 <= 3.25))]
)
B_N8[29] = np.nanmean(
    A_N101[np.where((A_N111 > 3.25) & (A_N111 <= 3.5))]
)
B_N8[30] = np.nanmean(
    A_N101[np.where((A_N111 > 3.5) & (A_N111 <= 3.75))]
)
B_N8[31] = np.nanmean(
    A_N101[np.where((A_N111 > 3.75) & (A_N111 <= 4))]
)
...
B_N9[0] = np.nanmean(
    A_N102[np.where((A_N112 > -4) & (A_N112 <= -3.75))]
)
B_N9[1] = np.nanmean(
    A_N102[np.where((A_N112 > -3.75) & (A_N112 <= -3.5))]
)
B_N9[2] = np.nanmean(
    A_N102[np.where((A_N112 > -3.5) & (A_N112 <= -3.25))]
)
B_N9[3] = np.nanmean(
    A_N102[np.where((A_N112 > -3.25) & (A_N112 <= -3))]
)
B_N9[4] = np.nanmean(
    A_N102[np.where((A_N112 > -3) & (A_N112 <= -2.75))]
)
B_N9[5] = np.nanmean(
    A_N102[np.where((A_N112 > -2.75) & (A_N112 <= -2.5))]
)
B_N9[6] = np.nanmean(
    A_N102[np.where((A_N112 > -2.5) & (A_N112 <= -2.25))]
)
B_N9[7] = np.nanmean(
    A_N102[np.where((A_N112 > -2.25) & (A_N112 <= -2))]
)
B_N9[8] = np.nanmean(
    A_N102[np.where((A_N112 > -2) & (A_N112 <= -1.75))]
)
B_N9[9] = np.nanmean(
    A_N102[np.where((A_N112 > -1.75) & (A_N112 <= -1.5))]
)
B_N9[10] = np.nanmean(
    A_N102[np.where((A_N112 > -1.5) & (A_N112 <= -1.25))]
)
B_N9[11] = np.nanmean(
    A_N102[np.where((A_N112 > -1.25) & (A_N112 <= -1))]
)
B_N9[12] = np.nanmean(
    A_N102[np.where((A_N112 > -1) & (A_N112 <= -0.75))]
)
B_N9[13] = np.nanmean(
    A_N102[np.where((A_N112 > -0.75) & (A_N112 <= -0.5))]
)
B_N9[14] = np.nanmean(
    A_N102[np.where((A_N112 > -0.5) & (A_N112 <= -0.25))]
)
B_N9[15] = np.nanmean(
    A_N102[np.where((A_N112 > -0.25) & (A_N112 <= 0))]
)
B_N9[16] = np.nanmean(
    A_N102[np.where((A_N112 > 0) & (A_N112 <= 0.25))]
)
B_N9[17] = np.nanmean(
    A_N102[np.where((A_N112 > 0.25) & (A_N112 <= 0.5))]
)
B_N9[18] = np.nanmean(
    A_N102[np.where((A_N112 > 0.5) & (A_N112 <= 0.75))]
)
B_N9[19] = np.nanmean(
    A_N102[np.where((A_N112 > 0.75) & (A_N112 <= 1))]
)
B_N9[20] = np.nanmean(
    A_N102[np.where((A_N112 > 1) & (A_N112 <= 1.25))]
)
B_N9[21] = np.nanmean(
    A_N102[np.where((A_N112 > 1.25) & (A_N112 <= 1.5))]
)
B_N9[22] = np.nanmean(
    A_N102[np.where((A_N112 > 1.5) & (A_N112 <= 1.75))]
)
B_N9[23] = np.nanmean(
    A_N102[np.where((A_N112 > 1.75) & (A_N112 <= 2))]
)
B_N9[24] = np.nanmean(
    A_N102[np.where((A_N112 > 2) & (A_N112 <= 2.25))]
)
B_N9[25] = np.nanmean(
    A_N102[np.where((A_N112 > 2.25) & (A_N112 <= 2.5))]
)
B_N9[26] = np.nanmean(
    A_N102[np.where((A_N112 > 2.5) & (A_N112 <= 2.75))]
)
B_N9[27] = np.nanmean(
    A_N102[np.where((A_N112 > 2.75) & (A_N112 <= 3))]
)
B_N9[28] = np.nanmean(
    A_N102[np.where((A_N112 > 3) & (A_N112 <= 3.25))]
)
B_N9[29] = np.nanmean(
    A_N102[np.where((A_N112 > 3.25) & (A_N112 <= 3.5))]
)
B_N9[30] = np.nanmean(
    A_N102[np.where((A_N112 > 3.5) & (A_N112 <= 3.75))]
)
B_N9[31] = np.nanmean(
    A_N102[np.where((A_N112 > 3.75) & (A_N112 <= 4))]
)
...
B_N10[0] = np.nanmean(
    A_N103[np.where((A_N113 > -4) & (A_N113 <= -3.75))]
)
B_N10[1] = np.nanmean(
    A_N103[np.where((A_N113 > -3.75) & (A_N113 <= -3.5))]
)
B_N10[2] = np.nanmean(
    A_N103[np.where((A_N113 > -3.5) & (A_N113 <= -3.25))]
)
B_N10[3] = np.nanmean(
    A_N103[np.where((A_N113 > -3.25) & (A_N113 <= -3))]
)
B_N10[4] = np.nanmean(
    A_N103[np.where((A_N113 > -3) & (A_N113 <= -2.75))]
)
B_N10[5] = np.nanmean(
    A_N103[np.where((A_N113 > -2.75) & (A_N113 <= -2.5))]
)
B_N10[6] = np.nanmean(
    A_N103[np.where((A_N113 > -2.5) & (A_N113 <= -2.25))]
)
B_N10[7] = np.nanmean(
    A_N103[np.where((A_N113 > -2.25) & (A_N113 <= -2))]
)
B_N10[8] = np.nanmean(
    A_N103[np.where((A_N113 > -2) & (A_N113 <= -1.75))]
)
B_N10[9] = np.nanmean(
    A_N103[np.where((A_N113 > -1.75) & (A_N113 <= -1.5))]
)
B_N10[10] = np.nanmean(
    A_N103[np.where((A_N113 > -1.5) & (A_N113 <= -1.25))]
)
B_N10[11] = np.nanmean(
    A_N103[np.where((A_N113 > -1.25) & (A_N113 <= -1))]
)
B_N10[12] = np.nanmean(
    A_N103[np.where((A_N113 > -1) & (A_N113 <= -0.75))]
)
B_N10[13] = np.nanmean(
    A_N103[np.where((A_N113 > -0.75) & (A_N113 <= -0.5))]
)
B_N10[14] = np.nanmean(
    A_N103[np.where((A_N113 > -0.5) & (A_N113 <= -0.25))]
)
B_N10[15] = np.nanmean(
    A_N103[np.where((A_N113 > -0.25) & (A_N113 <= 0))]
)
B_N10[16] = np.nanmean(
    A_N103[np.where((A_N113 > 0) & (A_N113 <= 0.25))]
)
B_N10[17] = np.nanmean(
    A_N103[np.where((A_N113 > 0.25) & (A_N113 <= 0.5))]
)
B_N10[18] = np.nanmean(
    A_N103[np.where((A_N113 > 0.5) & (A_N113 <= 0.75))]
)
B_N10[19] = np.nanmean(
    A_N103[np.where((A_N113 > 0.75) & (A_N113 <= 1))]
)
B_N10[20] = np.nanmean(
    A_N103[np.where((A_N113 > 1) & (A_N113 <= 1.25))]
)
B_N10[21] = np.nanmean(
    A_N103[np.where((A_N113 > 1.25) & (A_N113 <= 1.5))]
)
B_N10[22] = np.nanmean(
    A_N103[np.where((A_N113 > 1.5) & (A_N113 <= 1.75))]
)
B_N10[23] = np.nanmean(
    A_N103[np.where((A_N113 > 1.75) & (A_N113 <= 2))]
)
B_N10[24] = np.nanmean(
    A_N103[np.where((A_N113 > 2) & (A_N113 <= 2.25))]
)
B_N10[25] = np.nanmean(
    A_N103[np.where((A_N113 > 2.25) & (A_N113 <= 2.5))]
)
B_N10[26] = np.nanmean(
    A_N103[np.where((A_N113 > 2.5) & (A_N113 <= 2.75))]
)
B_N10[27] = np.nanmean(
    A_N103[np.where((A_N113 > 2.75) & (A_N113 <= 3))]
)
B_N10[28] = np.nanmean(
    A_N103[np.where((A_N113 > 3) & (A_N113 <= 3.25))]
)
B_N10[29] = np.nanmean(
    A_N103[np.where((A_N113 > 3.25) & (A_N113 <= 3.5))]
)
B_N10[30] = np.nanmean(
    A_N103[np.where((A_N113 > 3.5) & (A_N113 <= 3.75))]
)
B_N10[31] = np.nanmean(
    A_N103[np.where((A_N113 > 3.75) & (A_N113 <= 4))]
)


PCA = np.arange(-4, 4, 0.25)
...
plt.legend()
plt.title("EOF-CERES_Cldtau", fontsize=18)
